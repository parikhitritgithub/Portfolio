      ...
      <div className="grid gap-5 mt-16 sm:grid-cols-12">
        ...
        <div className=" min-h-[15rem] mt-6 p-3 sm:col-span-6">
          ...
          <h1 className="text-3xl p-2">Hello i.m </h1>
            ...
            <h1 className="text-3xl p-2 text-cyan-400"> 
            </h1>
            <div className="text-3xl p-2">
              Welcome to My Protfolio, Let's <FlipWords words={words} />
            </div>
          </div>
        ...
        <img src="/mainIconsdark.svg" alt="Main Icon Dark" className=" h-[28.5rem] , w-[38rem]"
         />
        </div>
      </div>
